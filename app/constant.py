...
STOPWORDS_ES = {
    ...
    'sus', 'le', 'ya', 'o', 'este', 'ha', 'sí', 'porque', 'esta', 'son', 
    'entre', 'está', 'cuando', 'muy', 'sin', 'sobre', 'también', 'me', 'hasta', 
    ...
    'estando', 'estado', 'estada', 'estados', 'estadas', 'he', 'has', 'ha', 
    ...
    'sentido', 'sentida', 'sentidos', 'sentidas', 'tengo', 'tienes', 'tiene', 
    ...
    'tenía', 'tenías', 'teníamos', 'teníais', 'tenían', 'tuve', 'tuviste', 
